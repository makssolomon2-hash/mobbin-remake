       ...
       {/*  <NavBar /> */}
        <section className="relative top-10 h-screen p-5 w-full flex items-center justify-center -z-1">
          <div className="hero-container 2k:-mt-80 w-[950px] text-center m-10">
            ...
            <h1 className="xl:text-[5.5rem] sm:text-[3rem]  font-bold text-black mt-10 leading-none ">Discover real-world design inspiration.</h1>
            <p className="text-xl m-3 text-gray-500">
