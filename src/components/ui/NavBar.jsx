...
const NavBar = () => {
  return (
    <div className="fixed top-0 left-1/2 -translate-x-1/2 w-[835px] font-sans  h-150px bg-gray-200/50 backdrop-blur-xl border-gray-200/60 rounded-full p-10px mt-7 font-medium z-999">
